...
Визначити розширення файлів (index.FUZZ)

Перебрати назви сторінок з відповідним розширенням (FUZZ.php)

Відкрити знайдені сторінки та перевірити на наявність чутливих даних
